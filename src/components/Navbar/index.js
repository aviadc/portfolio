  ...
  return (
    <nav className='navbar-container'>
      <div className={hamburgerClick ? "nav-menu active" : "nav-menu"}>
        ...
        <div>
          <Link to="about" spy={true} smooth={true} offset={-offsetInPixels} duration={0} className="nav-link">About</Link>
        </div>
        <div>
          <Link to="work" spy={true} smooth={true} offset={-offsetInPixels} duration={0} className="nav-link">Work</Link>
        </div>
        <div>
          <Link to="contact" spy={true} smooth={true} offset={-offsetInPixels} duration={0} className="nav-link">Contact</Link>
        </div>
      </div>
